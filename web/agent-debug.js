(() => {
  // web/agent-debug.jsx
  var { useState: ad_useState, useEffect: ad_useEffect, useRef: ad_useRef, useCallback: ad_useCallback } = React;
  var NikkoAgentLog = (() => {
